...
const ProfileMenu = ({onSignIn}) => {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 w-48 mt-2 bg-gray-700 rounded-lg shadow-lg">
          <a href="/profile" className="block px-4 py-2 text-white hover:bg-gray-600">
            Profile
          </a>
          <a href="/settings" className="block px-4 py-2 text-white hover:bg-gray-600">
            Settings
          </a>
          <a href="/help" className="block px-4 py-2 text-white hover:bg-gray-600">
            Help
          </a>
          <button onClick={handle} className="block w-full px-4 py-2 text-left text-white hover:bg-gray-600">
            Sign Out
          </button>
        </div>
      )}
